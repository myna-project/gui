...
# 
# Contributors:
#     Proxima Centauri srl <info@proxima-centauri.it> - optimizations (eg. BytesIO instead of StringIO)
#     Evan Fosmark (http://www.evanfosmark.com/2008/12/python-wsgi-middleware-for-automatic-gzipping/) initial implementation
#-------------------------------------------------------------------------------
'''
